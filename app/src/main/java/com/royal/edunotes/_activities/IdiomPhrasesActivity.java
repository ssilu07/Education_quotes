...
public class IdiomPhrasesActivity extends AppCompatActivity implements HomeFragment.OnFragmentInteractionListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isNetworkConnected()) {
            AlertDialog.Builder builder = new AlertDialog.Builder(IdiomPhrasesActivity.this);
            ...
            dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (isNetworkConnected()) {
                        ...
                        Toast.makeText(IdiomPhrasesActivity.this, "Still internet is not available ...", Toast.LENGTH_SHORT).show();
