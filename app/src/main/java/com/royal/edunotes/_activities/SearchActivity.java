...
public class SearchActivity extends AppCompatActivity {
    ...
    private String buildPrompt(String word) {
        return "You are an English vocabulary expert. Give me a detailed word analysis for the word \""
                + word + "\" strictly in this JSON format (no extra text, no markdown, just JSON):\n"
                + "{\n"
                + "  \"word\": \"" + word + "\",\n"
                + "  \"meaning\": \"Clear one-line definition\",\n"
                + "  \"trick\": \"A creative memory trick to remember this word\",\n"
